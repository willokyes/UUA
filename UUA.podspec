...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/willokyes/UUA"
  ...
  s.source       = { :git => "https://github.com/willokyes/UUA.git", :tag => s.version.to_s }
  ...
  s.source_files  = "UUA/UUA/**/*.{h,m,swift}"
